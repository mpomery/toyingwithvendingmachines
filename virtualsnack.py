...
class VirtualSnack(npyscreen.Form):
	...
	#self.mode=self.add(SnackButtonPress,name="MODE", relx=33)
        ...
        self.add(npyscreen.FixedText, value=u'\u2500'*28, editable=False, relx=46, rely=2)
        self.add(npyscreen.FixedText, value=u'\u2500'*24, editable=False, relx=46, rely=14)
        self.add(npyscreen.FixedText, value=u'\u2500'*24, editable=False, relx=46, rely=16)
        self.add(npyscreen.FixedText, value=u'\u2500'*28, editable=False, relx=46, rely=18)
        for i in range(3, 19):
            for j in [45, 74]:
                self.add(npyscreen.FixedText, value=u'\u2502', editable=False, relx=j, rely=i)
        for i in range(3, 18):
            self.add(npyscreen.FixedText, value=u'\u2502', editable=False, relx=69, rely=i)
        # All the fine details
        self.add(npyscreen.FixedText, value=u'\u250C', editable=False, relx=45, rely=2)
        self.add(npyscreen.FixedText, value=u'\u2510', editable=False, relx=74, rely=2)
        self.add(npyscreen.FixedText, value=u'\u252C', editable=False, relx=69, rely=2)
        self.add(npyscreen.FixedText, value=u'\u2534', editable=False, relx=69, rely=18)
        self.add(npyscreen.FixedText, value=u'\u251C', editable=False, relx=45, rely=14)
        self.add(npyscreen.FixedText, value=u'\u251C', editable=False, relx=45, rely=16)
        self.add(npyscreen.FixedText, value=u'\u251C', editable=False, relx=45, rely=18)
        self.add(npyscreen.FixedText, value=u'\u2524', editable=False, relx=69, rely=14)
        self.add(npyscreen.FixedText, value=u'\u2524', editable=False, relx=69, rely=16)
        self.add(npyscreen.FixedText, value=u'\u2524', editable=False, relx=74, rely=18)
	self.add(npyscreen.FixedText, value=u'\u2514\u2500\u2518', editable=False, relx=45, rely=19)
	self.add(npyscreen.FixedText, value=u'\u2514\u2500\u2518', editable=False, relx=72, rely=19)
        self.add(npyscreen.FixedText, value=u'\u252C', editable=False, relx=47, rely=18)
        self.add(npyscreen.FixedText, value=u'\u252C', editable=False, relx=72, rely=18)

        self.textdisplaymini = self.add(npyscreen.FixedText, value=u'####', editable=False, relx=70, rely=5)
